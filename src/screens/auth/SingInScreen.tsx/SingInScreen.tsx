                    ...
                    >
                        ...
                        <Box marginTop="s24" alignItems="center" mb="s24">
                            <Text
                                ...
                                marginTop="s16" textAlign="center"
                                marginHorizontal="s36"
                                mb="s16"
                                color="primaryContrast">Ao criar uma conta, você concorda com os
                                <Text
                                    bold
                                    preset="paragraphCaptionSmall"> {" "}Termos de Uso</Text> e a <Text bold preset="paragraphCaptionSmall">{" "}Política de Privacidade</Text></Text>
                            <Button title="Criar conta" onPress={() => { }} width={207} />
                            <Text
                                preset="paragraphSmall"
                                marginTop="s16" textAlign="center">Ja tem uma conta?{" "}
                                <Text
                                    bold
                                    color="blueOcean"
                                    onPress={() => navigation.goBack()}>Entrar</Text></Text>
                        </Box>
                    </Box>
                </Box>
            </ScrollView>
