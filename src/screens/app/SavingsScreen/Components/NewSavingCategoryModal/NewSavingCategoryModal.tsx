...
export function NewSavingCategoryModal({
  visible,
  onClose,
  onConfirm,
        ...
        >
          <TouchableWithoutFeedback>
            ...
            >
              ...
              >
                Escolha um nome e um ícone para o novo cofre.
              </Text>
              ...
              <Box marginTop="s16" alignItems="center" justifyContent="center">
                ...
                >
                  {selectedCategory
                    ? 'Esse será o ícone do cofre.'
                    : 'Selecione um ícone para o cofre.'}
                </Text>
              </Box>
              ...
              <Box marginTop="s16">
                <Text preset="paragraphSmall" semibold marginBottom="s8">
                  Ícones disponíveis para o cofre
                </Text>
