...
export function LoadingScreen({
    ...
    const renderContent = () => {
        ...
        if (status === "success") {
            return (
                <Icon name="progressSuccess" color="white" size={60} />
            );
        }

        if (status === "error") {
            return (
                <Icon name="progressCancel" color="white" size={60} />
            );
        }
    ...
    return (
        <Box flex={1} backgroundColor="greenPrimary" alignItems="center" justifyContent="center">
            <Animated.View
                style={{
